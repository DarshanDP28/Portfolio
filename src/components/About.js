                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
                        <div>
                            ...
                            <p className='slide-in-bottom'>
                                Currently persuing MCA.<br></br>
                                The technology I've learnt throughout : <span className="text-red ls-2">Asp.Net Core, Asp.Net Mvc, <br></br>
                                java, Sql, Html, Css, Js </span>
                            </p>
                            <p className='slide-in-bottom'>
